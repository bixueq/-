...
public:
	...
	//设置打印信息
	void SetupLogMsg(bool needShowRecvSpace = false, long recvMinSpace = 0, long recvMaxSpace = 0,
		bool needShowSendSpace = false, long SendMinSpace = 0, long SendMaxSpace = 0);
